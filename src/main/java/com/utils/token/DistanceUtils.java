...
public class DistanceUtils {
     ...
     * @return 两坐标的距离 米
     */
    public double getDistance(double latCenterRad, double lonCenterRad, double latVals, double lonVals) {
        //计算经纬度
        ...
        return (EARTH_MEAN_DIAMETER * Math.atan2(Math.sqrt(h), Math.sqrt(1 - h)))*1000;
    }
